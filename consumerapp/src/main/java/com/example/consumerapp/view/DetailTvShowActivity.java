...
import static com.example.consumerapp.db.DatabaseContract.FavoriteColumns.DESCRIPTION;
import static com.example.consumerapp.db.DatabaseContract.FavoriteColumns.IMG;
import static com.example.consumerapp.db.DatabaseContract.FavoriteColumns.TITLE;
import static com.example.consumerapp.db.DatabaseContract.FavoriteTVColumns.CONTENT_URI;
import static com.example.consumerapp.db.DatabaseContract.FavoriteTVColumns.TV_ID;
...
public class DetailTvShowActivity extends AppCompatActivity {
    ...
    public void CekFavorite() {
        Uri id = Uri.parse(CONTENT_URI+"/"+tvShow.getId());
        Cursor cursor = getContentResolver().query(id,null,null,null,null);
