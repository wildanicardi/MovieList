...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.example.submissionmovie.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.submissionmovie.EXTRA_ITEM";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent.getAction() != null) {
            if (intent.getAction().equals(TOAST_ACTION)) {
                ...
                favoriteHelper.open();
                ArrayList<ListMovie> list_favmovie = favoriteHelper.getallMovies();
